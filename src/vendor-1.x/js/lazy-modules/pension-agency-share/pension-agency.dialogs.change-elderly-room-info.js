    ...
    function DialogChangeElderlyRoomInfoController($scope,ngDialog) {
        ...
        function init() {
            ...
            vmh.parallel([
                ...
                var charge_standard = results[0].charge_standards[0];
                var tenantChargeStandardObject = _.find(results[0].charge_standards, function(o){
                        return o.subsystem == vm._subsystem_
                    }) || {};
                console.log(tenantChargeStandardObject);
                var charge_items = tenantChargeStandardObject.charge_items;
