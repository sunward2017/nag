...
module.exports = function(ctx,name) {
    ...
    if (module.isloaded) {
        ...
        var nursingWorkerScheduleTemplateSchema = new mongoose.Schema({
            ...
            content:[{
                ...
                y_axis: {type: mongoose.Schema.Types.ObjectId, required: true, ref: 'psn_nursingWorker'},
        ...
        nursingWorkerScheduleTemplateSchema.virtual('type_name').get(function () {
            if (this.type) {
        ...
        nursingWorkerScheduleTemplateSchema.virtual('stop_result_name').get(function () {
            if (this.stop_result) {
        ...
        nursingWorkerScheduleTemplateSchema.pre('update', function (next) {
            this.update({}, {$set: {operated_on: new Date()}});
            next();
        });

        return mongoose.model(name, nursingWorkerScheduleTemplateSchema, name);
    }
}