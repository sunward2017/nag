...
app.conf = {
    ...
    crossDomainInterceptor:{
        toPaths:['/services/share/login/medical/signin', '/services/share/login/medical/validateToken', '/me-services/api', '/me-services/trv', '/me-services/weixin/open', '/me-services/weixin/open', '/me-services/qiniu/open/uploadToken']
    },
    db: {
        //mssql数据库配置
        sqlserver: {
