    ...
    function InQRCodeController($scope, ngDialog, vmh, vm){
        ...
        function init() {
            ...
            vm.load().then(function(){
                ...
                vm.paste_in_pill_box_qrcode = 'http://tools.okertrip.com/node-ot/?text={"tenantId":"'+vm.model.tenantId+'","elderlyId":"'+vm.model.id+'", "name":"'+encodeURIComponent(vm.model.name)+'"}&ei=https://wx.qlogo.cn/mmhead/Q3auHgzwzM4bMub0HlUQejcYdLia8LORibXLl4vyot9SoLxNATehqUEQ/0'
            });
        }
    }
