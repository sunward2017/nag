  ...
  if (module.isloaded) {
    ...
    var tenantSchema = new mongoose.Schema({
      ...
      other_config: {
        ...
        psn_drug_stock_alarm_low_mode:{type: String, minlength: 5, maxlength: 5, enum: ctx._.rest(ctx.dictionary.keys["D3043"])},//药品低库存提醒方式,默认每次提醒A0001
        psn_drug_stock_out_mode:{type: String, minlength: 5, maxlength: 5, enum: ctx._.rest(ctx.dictionary.keys["D3028"])}, //出库模式
