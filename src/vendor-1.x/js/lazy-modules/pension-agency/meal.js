...
(function() {
    ...
    function MealDetailsController($scope, ngDialog, vmh, vm) {
        ...
        function priceChange() {
            vm.model.price = 0;
            for(var i=0,len=vm.model.meal.length;i<len;i++){
                vm.model.price +=vm.model.meal[i].price;
            }
        }
        ...
        function doSubmit() {
            ...
            if ($scope.theForm.$valid) {
                for(var i=0,len=vm.model.meal.length;i<len;i++){
                    vm.model.meal[i].dishItemId = vm.model.meal[i]._id;
                    vm.model.meal[i].dish_name = vm.model.meal[i].name;
                }
