    ...
    angular
        ...
        .constant('APP_REQUIRES', {
            ...
            modules: [
                ...
                {name:'subsystem.pension-agency.meal-weekly-menu.js',files:['app/js/lazy-modules/pension-agency/meal-weekly-menu.js']},
                {name:'subsystem.pension-agency.meal-weekly-menu-template.js',files:['app/js/lazy-modules/pension-agency/meal-weekly-menu-template.js']},
