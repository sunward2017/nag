      ...
      $get: ['$q', '$http', 'treeFactory', function ($q, $http, treeFactory) {
        ...
        return {
          ...
          tmp: function (id, select, where, populates, forceRefresh) {//tmg 本地过滤
            return this._tmp(id, select, where, null, populates, forceRefresh);
          },
          _tmp: function (id, select, where, sort, populates, forceRefresh) {//tmg 本地过滤
            var promise;
    ...
    return {
      ...
      $get: ['$http', function ($http) {
        ...
        function saveTenantConfig(tenantId, config) {
          return $http.post(baseUrl + 'saveTenantConfig/' + tenantId, {
            name: config.main.name,
            head_of_agency: config.main.head_of_agency,
    ...
    return {
      ...
      $get: ['$http', function ($http) {
        ...
        function exportExcelForEldelryPrintQRLabel(file_name, tenantId) {
          ...
          return $http.post(baseUrl + 'excel/eldelryPrintQRLabel', {
            file_name: file_name,
            tenantId: tenantId
          }, {responseType: 'blob'}).success(function (res) {
            console.log('res', res);
        ...
        function exportExcelForRoomBedPrintQRLabel(file_name, tenantId) {
          // return $http.post(baseUrl + 'excel/eldelryPrintQRLabel',  { tenantId: tenantId});
          return $http.post(baseUrl + 'excel/roomBedPrintQRLabel', {
            file_name: file_name,
            tenantId: tenantId
          }, {responseType: 'blob'}).success(function (res) {
            console.log('res', res);
        ...
        function queryDrug(tenantId, elderlyId, keyword, where, select, sort) {
        ...
        function drugUseItemRemove(elderlyId, tenantId, drugUseItemIds) {
          return $http.post(baseUrl + 'drugUseItemRemove', {
            elderlyId: elderlyId,
            tenantId: tenantId,
            drugUseItemIds: drugUseItemIds
          });
        }
        ...
        function drugStockEditLogInsert(tenantId, drugStockId, origin_quantity, revised_quantity, operated_by_name) {
          return $http.post(baseUrl + 'drugStockEditLogInsert', {
            tenantId: tenantId,
        ...
        function changeElderlyNursingLevel(tenantId, elderlyId, nursingLevelId, operated_by, operated_by_name) {
          return $http.post(baseUrl + 'changeElderlyNursingLevel', {
            tenantId: tenantId,
            elderlyId: elderlyId,
        ...
        function drugInStock(tenantId, operated_by, inStockData) {
          return $http.post(baseUrl + 'inStock', {
            tenantId: tenantId,
            operated_by: operated_by,
        ...
        function drugStockInRecordCheck(tenantId, drugInOutStockId) {
          return $http.post(baseUrl + 'drugStockInRecordCheck', {
            tenantId: tenantId,
            drugInOutStockId: drugInOutStockId
          });
        }

        function updateDrugsInStock(tenantId, drugInOutStockId, operated_by, model, drugs_to_remove) {
          var inStockData;
          ...
          return $http.post(baseUrl + 'updateDrugsInStock', {
            tenantId: tenantId,
            drugInOutStockId: drugInOutStockId,
            operated_by: operated_by,
            inStockData: inStockData
        ...
        function elderlyDrugStockSummary(tenantId, elderlyId, drugId) {
          return $http.post(baseUrl + 'elderlyDrugStockSummary', {
            tenantId: tenantId,
            elderlyId: elderlyId,
            drugId: drugId
          });
        ...
        function drugOutStock(tenantId, operated_by, outStockData) {
          return $http.post(baseUrl + 'outStock', {
            tenantId: tenantId,
            operated_by: operated_by,
            outStockData: outStockData
          });
        ...
        function updateDrugsOutStock(tenantId, drugInOutStockId, operated_by, model, drugs_to_remove) {
          ...
          return $http.post(baseUrl + 'updateDrugsOutStock', {
            tenantId: tenantId,
            drugInOutStockId: drugInOutStockId,
            operated_by: operated_by,
            outStockData: outStockData
        ...
        function queryElderlyDrugStock(tenantId, elderlyId, keyword) {
          return $http.post(baseUrl + 'q/elderlyDrugStock', {
            tenantId: tenantId,
            elderlyId: elderlyId,
            keyword: keyword
          });
        ...
        function nursingScheduleTemplateImport(nursingScheduleTemplateId, toImportXAxisRange) {
          return $http.post(baseUrl + 'nursingScheduleTemplateImport', {
            nursingScheduleTemplateId: nursingScheduleTemplateId,
        ...
        function nursingScheduleSaveAsTemplateWeekly(tenantId, nursingScheduleTemplateName, toSaveRows) {
          return $http.post(baseUrl + 'nursingScheduleSaveAsTemplateWeekly', {
            tenantId: tenantId,
            nursingScheduleTemplateName: nursingScheduleTemplateName,
            toSaveRows: toSaveRows
          });
        }

        function nursingScheduleByElderlyDaily(tenantId, elderlyId, dateString) {
          return $http.post(baseUrl + 'nursingScheduleByElderlyDaily', {
            tenantId: tenantId,
            elderlyId: elderlyId,
        ...
        function nursingPlansByRoom(tenantId, elderlySelectArray, nursingPlanSelectArray) {
          return $http.post(baseUrl + 'nursingPlansByRoom', {
            tenantId: tenantId,
            elderlySelectArray: elderlySelectArray,
            nursingPlanSelectArray: nursingPlanSelectArray
          });
        }

        function nursingPlanSaveNursingItem(tenantId, elderlyId, work_item_check_info) {
          return $http.post(baseUrl + 'nursingPlanSaveNursingItem', {
            tenantId: tenantId,
            elderlyId: elderlyId,
            work_item_check_info: work_item_check_info
          });
        }

        function nursingPlanSaveAll(tenantId, elderlyId, type, workItemIds, checked) {
          return $http.post(baseUrl + 'nursingPlanSaveAll', {
            tenantId: tenantId,
            elderlyId: elderlyId,
            type: type,
        ...
        function nursingPlanSaveRemark(tenantId, elderlyId, remark) {
          return $http.post(baseUrl + 'nursingPlanSaveRemark', {
            tenantId: tenantId,
            elderlyId: elderlyId,
            remark: remark
          });
        ...
        function nursingStationCloseBedMonitorAlarm(alarmId, sharedData) {
          return $http.post(baseUrl + 'nursingStationCloseBedMonitorAlarm', {
            alarmId: alarmId,
            operated_by: sharedData.operated_by,
            operated_by_name: sharedData.operated_by_name
          });
        }

        function nursingLevelsByAssessmentGrade(tenantId, nursing_assessment_grade) {
          return $http.post(baseUrl + 'nursingLevelsByAssessmentGrade', {
            tenantId: tenantId,
        ...
        function customizedWorkItem(workItemId, customizedWorkItem) {
          return $http.post(baseUrl + 'customizedWorkItem', {
        ...
        function nursingWorkerScheduleTemplateImport(nursingWorkerScheduleTemplateId, toImportXAxisRange) {
          return $http.post(baseUrl + 'nursingWorkerScheduleTemplateImport', {
            nursingWorkerScheduleTemplateId: nursingWorkerScheduleTemplateId,
            toImportXAxisRange: toImportXAxisRange
          });
        }
